...
class HijriMonthPicker extends StatefulWidget {
  ...
  ///Called when user change month
  final ValueChanged<HijriCalendar>? onMonthChanged;
...
const _HijriDayPickerGridDelegate _kDayPickerGridDelegate = _HijriDayPickerGridDelegate();
...
Future<HijriCalendar?> showHijriDatePicker({
  ...
  assert(!initialDate.isBefore(firstDate.hYear, firstDate.hMonth, firstDate.hDay), 'initialDate must be on or after firstDate');
  assert(!initialDate.isAfter(lastDate.hYear, lastDate.hMonth, lastDate.hDay), 'initialDate must be on or before lastDate');
